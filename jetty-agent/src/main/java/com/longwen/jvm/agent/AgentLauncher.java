...
public class AgentLauncher {
    ...
    private static final String CLASS_OF_CORE_CONFIGURE = "com.longwen.server.jetty.CoreConfigure";
    // private static final String CLASS_OF_JETTY_CORE_SERVER = "com.alibaba.jvm.sandbox.core.server.jetty.JettyCoreServer";
    private static final String CLASS_OF_PROXY_CORE_SERVER = "com.longwen.server.jetty.ProxyCoreServer";
