...
import com.longwen.server.app.api.http.Http;
...
import static com.longwen.server.util.GaStringUtils.matching;
...
public class ModuleHttpServlet extends HttpServlet{
    ...
    private void doMethod(final HttpServletRequest req,
        ...
        final PrintWriter writer = coreModule.append(new CoreModule.ReleaseResource<PrintWriter>(resp.getWriter()) {
