...
public @interface Information {
     ...
     * @return 期待沙箱的加载模式
     */
    com.longwen.server.app.api.Information.Mode[] mode() default {com.longwen.server.app.api.Information.Mode.AGENT, com.longwen.server.app.api.Information.Mode.ATTACH};
